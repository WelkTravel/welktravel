    ...
    <>
      <header className="sticky top-0 z-50 bg-navy border-b border-navy-light">
        <div className="max-w-6xl mx-auto flex items-center justify-between px-6 py-3">
          ...
          <nav className="hidden md:flex gap-6 text-sm text-mauve font-body items-center">
            <Link href="/#planes" className="hover:text-gold transition-colors">Nuestros Planes</Link>
            <Link href="/#conserjeria-aerea" className="hover:text-gold transition-colors">Conserjería Aérea</Link>
            <Link href="/#respaldo" className="hover:text-gold transition-colors">Respaldo Operativo</Link>
            <a
      ...
      {/* Barra legal — NIT pendiente de completar con el dato real. El RNT se
          agrega aquí solo cuando esté radicado/aprobado (ver decisión de negocio). */}
      ...
      <footer className="bg-navy border-t border-navy-light py-8">
        <div className="max-w-6xl mx-auto px-6 flex flex-col items-center gap-5">
          ...
          <nav className="flex gap-6 text-xs text-mauve font-body">
            <Link href="/preguntas-frecuentes" className="hover:text-gold transition-colors">Preguntas frecuentes</Link>
            <Link href="/politica-de-tratamiento-de-datos" className="hover:text-gold transition-colors">Política de datos</Link>
