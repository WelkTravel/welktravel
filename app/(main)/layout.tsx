...
const enlacesInstitucionales = [
  ...
  { nombre: 'RUES', href: 'https://www.rues.org.co' },
  { nombre: 'Aerocivil', href: 'https://www.aerocivil.gov.co' },
];

const enlacesLegales = [
  { nombre: 'Términos y condiciones', href: '/terminos-y-condiciones' },
  { nombre: 'Política de privacidad y datos personales', href: '/politica-de-tratamiento-de-datos' },
  { nombre: 'Derechos del pasajero', href: '/derechos-del-pasajero' },
  { nombre: 'Política contra pornografía infantil', href: '/politica-pornografia-infantil' },
  { nombre: 'Denuncie situaciones que afectan a menores de 18 años', href: '/denuncias-menores' },
];

const enlacesServicio = [
  { nombre: 'Preguntas frecuentes', href: '/preguntas-frecuentes' },
  { nombre: 'PQRS', href: '/pqrs' },
...
export default function MainLayout({
  ...
  return (
    <>
      ...
      {/* Barra legal */}
      <div className="bg-navy-deep text-center py-1.5 text-[11px] text-mist font-body flex flex-wrap justify-center gap-x-6 gap-y-1 px-4 tracking-wide">
        <span>NIT 902.087.020-3</span>
        <span>RNT 297107</span>
        <span>KR 14 No. 63-73, Bogotá</span>
      </div>

      <main>{children}</main>

      <footer className="bg-navy border-t border-navy-light py-10">
        <div className="max-w-6xl mx-auto px-6 flex flex-col items-center gap-8">
          <div className="flex gap-5">
            <a href="#" aria-label="Facebook" className="text-mist hover:text-white transition-colors">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                <path d="M22 12.06C22 6.5 17.52 2 12 2S2 6.5 2 12.06c0 5.02 3.66 9.18 8.44 9.94v-7.03H7.9v-2.91h2.54V9.85c0-2.51 1.49-3.9 3.77-3.9 1.09 0 2.24.2 2.24.2v2.46h-1.26c-1.24 0-1.63.77-1.63 1.56v1.89h2.78l-.44 2.91h-2.34V22c4.78-.76 8.44-4.92 8.44-9.94Z"/>
              </svg>
            </a>
            <a href="#" aria-label="Instagram" className="text-mist hover:text-white transition-colors">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
            ...
            <a href="#" aria-label="LinkedIn" className="text-mist hover:text-white transition-colors">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
            ...
            <a href="#" aria-label="YouTube" className="text-mist hover:text-white transition-colors">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
            ...
            <a href="#" aria-label="TikTok" className="text-mist hover:text-white transition-colors">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 w-full text-center sm:text-left">
            <div>
              <p className="font-title text-cream text-xs tracking-wide mb-2">Servicio al cliente</p>
              <nav className="flex flex-col gap-1.5">
                {enlacesServicio.map((e) => (
                  <Link key={e.href} href={e.href} className="font-body text-xs text-mist hover:text-white transition-colors">
                    {e.nombre}
                  </Link>
                ))}
            ...
            <div>
              <p className="font-title text-cream text-xs tracking-wide mb-2">Legal</p>
              <nav className="flex flex-col gap-1.5">
            ...
            <div>
              <p className="font-title text-cream text-xs tracking-wide mb-2">Entidades de control</p>
              <nav className="flex flex-col gap-1.5">
                {enlacesInstitucionales.map((e) => (
                  <a
                    ...
                    className="font-body text-xs text-mist hover:text-white transition-colors"
                  >
                    {e.nombre}
                  </a>
                ))}
          ...
          <p className="text-center text-xs text-mist font-body">
